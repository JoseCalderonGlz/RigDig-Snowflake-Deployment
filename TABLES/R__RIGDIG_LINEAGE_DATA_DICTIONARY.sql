create TABLE if not exists ITD_SCHEMACHANGE_DEMO.RIGDIG_LINEAGE_DATA_DICTIONARY (
	FIELD_NAME VARCHAR(16777216),
	DESCRIPTION VARCHAR(16777216)
);


INSERT INTO ITD_SCHEMACHANGE_DEMO.RIGDIG_LINEAGE_DATA_DICTIONARY VALUES
