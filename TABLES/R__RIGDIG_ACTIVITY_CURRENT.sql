...
call ITD_SCHEMACHANGE_DEMO.SafeAddColumn('OMEGA_TEST_DB.ITD_SCHEMACHANGE_DEMO.RIGDIG_ACTIVITY_CURRENT', 'new_column', 'varchar(12312313)');


--STORED PROCEDURE TO REMOVE A COLUMN
--TABLE NAME, COLUMN NAME
call ITD_SCHEMACHANGE_DEMO.SafeDropColumn('ITD_SCHEMACHANGE_DEMO.RIGDIG_ACTIVITY_CURRENT', 'new_column');



call ITD_SCHEMACHANGE_DEMO.SafeAddColumn('OMEGA_TEST_DB.ITD_SCHEMACHANGE_DEMO.RIGDIG_ACTIVITY_CURRENT', 'new_column2', 'varchar(12312313)');
call ITD_SCHEMACHANGE_DEMO.SafeDropColumn('ITD_SCHEMACHANGE_DEMO.RIGDIG_ACTIVITY_CURRENT', 'new_column2');
