...
call PUBLIC.SafeAddColumn('ITD_SCHEMACHANGE_DEMO.RIGDIG_ACTIVITY_CURRENT', 'new_column', 'varchar(12312313)');


--STORED PROCEDURE TO REMOVE A COLUMN
--TABLE NAME, COLUMN NAME
call PUBLIC.SafeDropColumn('ITD_SCHEMACHANGE_DEMO.RIGDIG_ACTIVITY_CURRENT', 'new_column');


call PUBLIC.SafeAddColumn('ITD_SCHEMACHANGE_DEMO.RIGDIG_ACTIVITY_CURRENT', 'new_column2', 'varchar(12312313)');

call PUBLIC.SafeDropColumn('ITD_SCHEMACHANGE_DEMO.RIGDIG_ACTIVITY_CURRENT', 'new_column2');
