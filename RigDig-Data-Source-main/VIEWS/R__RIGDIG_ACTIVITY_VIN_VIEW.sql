CREATE OR REPLACE VIEW OMEGA_PROD_DB.ITD_SCHEMACHANGE_DEMO.RIGDIG_ACTIVITY_VIN_VIEW AS (
SELECT RRID
      ,ACT_SOURCE
      ...
      ,EQT_VIN_SN
      ,"ITD_CUSTOMER_360".VIN_CONFORMITY(EQT_VIN_SN)::VARCHAR(30) AS VIN_CONFORMITY
      ,"ITD_CUSTOMER_360".VIN_CHECKSUM(EQT_VIN_SN) AS VIN_CHECKSUM
FROM OMEGA_PROD_DB.ITD_SCHEMACHANGE_DEMO."RIGDIG_ACTIVITY_LATEST"
