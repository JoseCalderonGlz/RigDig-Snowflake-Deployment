CREATE OR REPLACE VIEW OMEGA_TEST_DB.ITD_SCHEMACHANGE_DEMO.RIGDIG_LINEAGE_LATEST
...
WITH MAX_RPT_YR_MONTH AS (
  ...
  FROM OMEGA_TEST_DB.ITD_SCHEMACHANGE_DEMO.RIGDIG_LINEAGE_ALL
)
SELECT RPT_YR
      ,RPT_MONTH
      ,RRID
...
FROM OMEGA_TEST_DB.ITD_SCHEMACHANGE_DEMO.RIGDIG_LINEAGE_ALL a
